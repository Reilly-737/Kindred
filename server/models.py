...
class Artwork(db.Model, SerializerMixin):
    ...
    serialize_only = ("artwork_id", "title", "image_url","tags.title", "user.username", "user_id", "artwork_tags.tag.title" )
...
class DiscussionPost(db.Model, SerializerMixin):
    ...
    serialize_only = ("post_id", "title", "body","tags.title", "user.username", "user_id","post_tags.tag.title")
