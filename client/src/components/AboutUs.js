      ...
      <Container>
        ...
        <Row>
          <Col sm="12" md="6">
            ...
            <p>
              Respectful Community: Any content that promotes discrimination,
              hate, or harm will not be tolerated.{" "}
            </p>
            <p>Originality Matters: Plagiarism is strictly prohibited.</p>
            <p>
              Wholesome Environment: Constructive criticism is welcome, but any
              form of bulling or harassment will result in immediate action.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              better serve the community. You will be notified of any
              significant changes. By using Kindred, you agree to abide by these
              terms.
            </p>
          ...
          <Col sm="12" md="6">
            ...
            <p>
              I'm Reilly, the creator of Kindred! As an artist myself,
              specializing in expressionist, childlike forms, my pieces delve
              into the odd realms of body dysmorphia, disconnection, death,
              existentialism, and spirituality. Through my art, I aim to explore
              what this existence means to me and what does it mean to be alive?
            </p>
            <p>
              ...
              where every brushstroke, sculpture, or performance is a step
              towards fostering a community that appreciates artistic
              expression.
            </p>
            <img
